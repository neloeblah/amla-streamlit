...
#         "../src/data/Distance_of_All_Airports_20231022_000915.csv"
#     )
...
#     """
#     Retrieve menu options for user selection.

#     Reads flight itinerary data and extracts options for user selection.

#     Returns:
#         dict: Dictionary with menu options.
#     """
#     df = pd.read_csv("../data/raw/itineraries_csv/ATL/ATL_itineraries_aa.zip")
